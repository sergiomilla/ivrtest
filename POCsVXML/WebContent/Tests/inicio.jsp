...
<vxml version="3.1" xmlns="http://www.w3.org/2001/vxml" xml:lang="en-US" xml:base="http://<%= request.getServerName() %>:<%= request.getServerPort() + "/POCsVXML/Tests/" %>"  >


 <!--  
<vxml version="3.1" xmlns="http://www.w3.org/2001/vxml" xml:lang="de-DE" xml:base="http://<%= request.getServerName() %>:<%= request.getServerPort() + "/POCsVXML/Tests/" %>"  >
  -->


	<var name="PRM_codigoRetorno22" expr="''"/>
	<var name="fromV21Tests" expr="false" />
	<var name="gitNuevaVar2" />

	<!-- 
	************************************************
	******************* Probando commit hook *********************
	************************************************
	-->
