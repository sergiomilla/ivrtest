...
<form id="start">
  ...
  <record name="recording" beep="true" dtmfterm="true" maxtime="10s" modal="true" type="audio/x-wav">
   ...
   <filled>
		...
		<log>********** recording size = <value expr="recording$.size"/> bytes.</log>
		<log>********** recording duration = <value expr="recording$.duration"/> milliseconds.</log>
		<log>********** dtmf key = <value expr="(recording$.termchar ? recording$.termchar : 'none')"/></log>
		<log>********** maxtime = <value expr="recording$.maxtime"/>.</log>
